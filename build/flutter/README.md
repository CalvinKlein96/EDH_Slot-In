...
* `edhrec_checker` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `EDHREC_checker` - executable or bundle name on disk.
* `EDHREC_checker` - display name shown in window titles and about app dialogs.
